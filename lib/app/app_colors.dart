...
//light
  ...
  static const primaryLight = Color(0xFF110E47);
  static const secondaryLight = Color(0xFF9C9C9C); //used for activated switchers
  static const backgroundLight = Color(0xFFFFE9B1);
  static const scaffoldLight = Color(0xFFFFE9B1);

  static const chipColorLight = Color(0xFFDBE3FF);
  static const chipTextLight = Color(0xFF88A4E8);

  static const formFillLight = Color(0xFFF9CE60);
