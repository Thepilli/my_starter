...
_$_FireredLeafgreen _$$_FireredLeafgreenFromJson(Map<String, dynamic> json) =>
    _$_FireredLeafgreen(
      backDefault: json['back_default'] as String?,
      backShiny: json['back_shiny'] as String?,
      frontDefault: json['front_default'] as String?,
...
Map<String, dynamic> _$$_FireredLeafgreenToJson(_$_FireredLeafgreen instance) =>
    <String, dynamic>{
      'back_default': instance.backDefault,
      'back_shiny': instance.backShiny,
      'front_default': instance.frontDefault,
...
_$_DiamondPearl _$$_DiamondPearlFromJson(Map<String, dynamic> json) =>
    _$_DiamondPearl(
      backDefault: json['back_default'] as String?,
      backFemale: json['back_female'] as String?,
      backShiny: json['back_shiny'] as String?,
...
Map<String, dynamic> _$$_DiamondPearlToJson(_$_DiamondPearl instance) =>
    <String, dynamic>{
      'back_default': instance.backDefault,
      'back_female': instance.backFemale,
      'back_shiny': instance.backShiny,
...
_$_GenerationVii _$$_GenerationViiFromJson(Map<String, dynamic> json) =>
    _$_GenerationVii(
      icons: json['icons'] == null
          ? null
          : GenerationViiIcons.fromJson(json['icons'] as Map<String, dynamic>),
...
_$_GenerationViiIcons _$$_GenerationViiIconsFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$_GenerationViiIconsToJson(
        _$_GenerationViiIcons instance) =>
    <String, dynamic>{
      'front_default': instance.frontDefault,
      'front_female': instance.frontFemale,
    };
...
_$_GenerationViii _$$_GenerationViiiFromJson(Map<String, dynamic> json) =>
    _$_GenerationViii(
      icons: json['icons'] == null
          ? null
          : GenerationViiiIcons.fromJson(json['icons'] as Map<String, dynamic>),
    );
...
_$_GenerationViiiIcons _$$_GenerationViiiIconsFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$_GenerationViiiIconsToJson(
        _$_GenerationViiiIcons instance) =>
    <String, dynamic>{
      'front_default': instance.frontDefault,
      'front_female': instance.frontFemale,
    };
