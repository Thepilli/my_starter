...
class TabContainerWidget extends ConsumerWidget {
  const TabContainerWidget({super.key});
            ...
            children: [
              SizedBox(
                ...
                child: AspectRatio(
                  ...
                  child: TabContainer(
                    ...
                    selectedTextStyle: context.textTheme.bodyMedium?.copyWith(fontSize: 15.0),
                    unselectedTextStyle: context.textTheme.bodyMedium?.copyWith(fontSize: 13.0),
                    tabs: _getTabs1(),
              ...
              Expanded(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(20.0),
                  child: TabContainer(
                    childDuration: const Duration(seconds: 3),
                    colors: const [
                      AppColors.red,
                      AppColors.blue,
